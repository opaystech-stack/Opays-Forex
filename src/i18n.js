...
const translations = {
  fr: {
    ...
    employees: {
      ...
      deleted: 'Employé retiré.',
      empty: 'Aucun employé enregistré.',
      name: 'Nom'
    },
    transfers: {
      title: 'Transferts Internes',
      subtitle: 'Déplacez des fonds entre caisses de la même agence.',
      sourceWallet: 'Caisse source',
      destWallet: 'Caisse destination',
      amount: 'Montant',
      note: 'Note',
      send: 'Effectuer le transfert',
      created: 'Transfert enregistré.',
      empty: 'Aucun transfert.',
      date: 'Date',
      from: 'De',
      to: 'Vers',
      status: 'Statut',
      walletsRequired: 'Les deux caisses sont requises.',
      amountRequired: 'Le montant doit être positif.',
      sameWallet: 'La caisse source et destination doivent être différentes.',
      internalTransfer: 'Transfert interne'
    },
    subscriptions: {
      title: 'Abonnements Clients',
      subtitle: 'Services récurrents facturés à vos clients.',
      customer: 'Client',
      ...
      monthly: 'Mensuel',
      yearly: 'Annuel',
      nextDate: 'Prochaine échéance',
      add: 'Ajouter',
      created: 'Abonnement créé.',
      renewed: 'Échéance reportée de 30 jours.',
    ...
    remoteOrders: {
      ...
      subtitle: 'Ordres reçus par WhatsApp, Telegram, SMS ou app.',
      customerName: 'Nom client',
      customerPhone: 'Téléphone client',
      sourceCurrency: 'Devise donnée',
      destCurrency: 'Devise reçue',
      ...
      execute: 'Exécuter',
      executed: 'Commande exécutée et transaction créée.',
      noWallet: 'Aucune caisse trouvée pour cette devise.',
      empty: 'Aucune commande distante.',
      from: 'Canal'
    },
    superAdmin: {
      ...
      accessDeniedDesc: 'Vous devez être super administrateur pour accéder à cette page.',
      totalAgencies: 'Agences',
      totalUsers: 'Utilisateurs',
      totalRevenue: 'Revenus MRR',
      activeToday: 'Actifs aujourd\'hui',
      agencies: 'Agences inscrites',
      noAgencies: 'Aucune agence inscrite pour le moment.',
      name: 'Nom',
      owner: 'Propriétaire',
      status: 'Statut',
      created: 'Créée le',
  ...
  en: {
    ...
    employees: {
      title: 'Employees',
      subtitle: 'Manage your team access.',
      add: 'Add',
      email: 'Email',
    ...
    transfers: {
      ...
      subtitle: 'Move funds between cashboxes within the same agency.',
      ...
      to: 'To',
      status: 'Status',
      walletsRequired: 'Both wallets are required.',
      amountRequired: 'Amount must be positive.',
      sameWallet: 'Source and destination must differ.',
      internalTransfer: 'Internal transfer'
    },
    subscriptions: {
      title: 'Customer Subscriptions',
      subtitle: 'Recurring services billed to your customers.',
      customer: 'Customer',
      ...
      renewed: 'Due date extended by 30 days.',
    ...
    tickets: {
      ...
      subtitle: 'Track requests and incidents.',
      subject: 'Subject',
      body: 'Description',
      create: 'Open ticket',
    ...
    remoteOrders: {
      title: 'Remote Orders',
      subtitle: 'Orders received via WhatsApp, Telegram, SMS or call.',
      customerName: 'Customer name',
      customerPhone: 'Customer phone',
      sourceCurrency: 'Given currency',
      destCurrency: 'Received currency',
      sourceAmount: 'Given amount',
      destAmount: 'Received amount',
      note: 'Note',
      add: 'Create order',
      created: 'Order recorded.',
      execute: 'Execute',
      executed: 'Order executed and transaction created.',
      noWallet: 'No wallet found for this currency.',
      empty: 'No remote orders.',
      from: 'Channel'
    },
    superAdmin: {
      ...
      accessDeniedDesc: 'You must be a super administrator to access this page.',
      totalAgencies: 'Agencies',
      totalUsers: 'Users',
      totalRevenue: 'MRR Revenue',
      activeToday: 'Active today',
      agencies: 'Registered agencies',
      noAgencies: 'No agencies registered yet.',
      name: 'Name',
      owner: 'Owner',
      status: 'Status',
      created: 'Created',
